...
export function GanttChart({ tasks: initialTasks, capacity: initialCapacity, onAllocate, onComplete, onView, projects, currentProject, onProjectChange, showAllocateButton = false, onAllocateClick }: Props) {
