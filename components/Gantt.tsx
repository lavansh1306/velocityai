...
capacity: CapEvent[] // freed-time pills; prefiltered by project in the page
...
return { start, spanDays:7, gridCols:220px repeat(7, 1fr) 240px, rows:[] as Row[], capByDay:{} as Record<number,CapEvent[]> }
}
...
<div className="cell" style={{padding:'6px 8px', fontWeight:600}}>Actions</div>
    ...
    <div className="actionCell"><span className="small">Pills show when/where time was freed.</span></div>
